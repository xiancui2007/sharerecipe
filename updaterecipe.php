...
<?php
require_once 'php/updaterecipe validation.php';
?>
<header>
...
<form id='mainForm' name="mainForm" method="post" enctype="multipart/form-data" action="">
  <fieldset>
     <legend>Upload Your Recipe Here</legend>
      <p><span class="error">* All fields required. Do not need to upload pic if want to keep the original one.</span></p>
      <p>
     ...
     <label>(optional) Upload a Pic of the Dish (small than 488kb, JPG, JPEG, PNG & GIF only): </label>
